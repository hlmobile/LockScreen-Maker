...
- (void)viewDidLoad {
	...
	NSString *connectionURL=[[NSString alloc] initWithString:[[tempArray objectForKey:@"MoreLink"] stringByAddingPercentEscapesUsingEncoding:NSASCIIStringEncoding]];
